...
public class FileUpdDataTest {
  ...
  public void shouldReturnTheDate() {
    assertThat(
        create(date, workspace, duration, file).get(IFileUpdData.DATE),
        is(date));
  }
  ...
  public void shouldReturnTheDuration() {
    assertThat(
        create(date, workspace, duration, file).get(IFileUpdData.DURATION),
        is(duration));
  }
  ...
  public void shouldReturnTheFile() {
    assertThat(
        create(date, workspace, duration, file).get(IFileUpdData.FILE),
        is(file));
  }
  ...
  public void shouldReturnTheWorkspace() {
    assertThat(
        create(date, workspace, duration, file).get(IFileUpdData.WORKSPACE),
        is(workspace));
  }
   ...
   */
  private FileUpdData create(LocalDate date,
